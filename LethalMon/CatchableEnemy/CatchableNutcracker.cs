...
internal class CatchableNutcracker() : CatchableEnemy("Nutcracker", 9,
    "As devoted guardians, they will guard their master and shoot any enemies within line of sight. Though be careful to stay away from the line of fire.\nWhen the thrower fails to capture a Nutcracker, it will enter a manic state where it will rotate wildly while shooting in all directions.")
{
