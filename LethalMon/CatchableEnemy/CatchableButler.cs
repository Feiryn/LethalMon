...
internal class CatchableButler() : CatchableEnemy("Butler", 4,
    "It will clean up any carcases and residue left behind by enemies, salvaging valuables from them in the process.\nA failed capture will cause them to brutally stab the thrower to death.")
{
