...
{
    internal class CatchableKidnapperFox() : CatchableEnemy("Fox", 4,
        "Though tamed, Kidnapper foxes will remain as aggressive as ever, shooting their tongue at enemies to damage them for the safety of their owner.\nUpon failing a capture, a chase sequence will commence similar to its behavior when untamed.")
    {
